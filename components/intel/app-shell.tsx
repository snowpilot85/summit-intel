...
/* ============================================
   ...
   EL Compliance & Instruction Platform
   ============================================ */
      ...
      <div className="h-[120px] lg:h-[130px] px-4 lg:px-6">
        <div className="h-full flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            {/* Summit K12 IntELL Logo with subtitle */}
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                <Image
                  ...
                  priority
                />
                <span className="text-[20px] font-semibold text-teal-300">IntELL</span>
              </div>
              <p className="text-[11px] opacity-70 mt-1 tracking-wide">EL Compliance & Instruction</p>
            </div>
          </div>
...
export const IntelBreadcrumbs = ({ items, className }: BreadcrumbsProps) => {
  return (
    <nav
...
const intelNavItems = [
  { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, href: "/intel" },
  { id: "students", label: "Students", icon: Users, href: "/intel/students" },
  { id: "lpac-meetings", label: "LPAC Meetings", icon: Calendar, href: "/intel/meetings" },
  { id: "reports", label: "Reports", icon: FileText, href: "/intel/reports" },
  { id: "ccmr", label: "CCMR Tracker", icon: GraduationCap, href: "/intel/ccmr" },
  { id: "data-upload", label: "Data Upload", icon: Upload, href: "/intel/upload" },
...
export const IntelNavRail = ({ activeItem = "dashboard", onItemChange, className }: NavRailProps) => {
  return (
    <aside
      className={cn(
...
interface IntelAppShellProps {
  children: React.ReactNode;
  headerProps?: IntelHeaderProps;
  breadcrumbs?: BreadcrumbItem[];
  activeNavItem?: string;
  onNavItemChange?: (item: string) => void;
}

export const IntelAppShell = ({
  children,
  headerProps,
  breadcrumbs = [
  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-50">
      {/* Header */}
      <IntelHeader {...headerProps} />

      {/* Breadcrumbs */}
      <IntelBreadcrumbs items={breadcrumbs} />

      {/* Main Layout */}
      <div className="flex flex-1">
        {/* Nav Rail */}
        <IntelNavRail activeItem={activeNavItem} onItemChange={onNavItemChange} />
...
export const IntelMobileNavBar = ({ activeItem = "dashboard", onItemChange, className }: MobileNavBarProps) => {
  const mobileNavItems = intelNavItems.slice(0, 4);
